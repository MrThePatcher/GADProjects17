...
public final class SerializableOptional<T> implements Serializable {
  ...
  private static final long serialVersionUID = 1L;
     ...
     * @return an {@code SerializableOptional} with a present value if the specified value
    ...
    /**
     * If a value is present in this {@code SerializableOptional}, returns the value,
     ...
     * @return an {@code SerializableOptional} describing the result of applying a mapping
     * function to the value of this {@code SerializableOptional}, if a value is present,
     * otherwise an empty {@code SerializableOptional}
    ...
    /**
     * If a value is present, apply the provided {@code SerializableOptional}-bearing
    ...
    /**
     * Returns a non-empty string representation of this SerializableOptional suitable for
